...
from sam3d.configuration import default_num_threads
from sam3d.experiment_planning.DatasetAnalyzer import DatasetAnalyzer
from sam3d.experiment_planning.common_utils import get_pool_and_conv_props_poolLateV2
from sam3d.experiment_planning.utils import create_lists_from_splitted_dataset
from sam3d.network_architecture.generic_UNet import Generic_UNet
from sam3d.paths import *
from sam3d.preprocessing.cropping import get_case_identifier_from_npz
from sam3d.training.model_restore import recursive_find_python_class
...
class ExperimentPlanner(object):
    ...
    def run_preprocessing(self, num_threads):
        ...
        preprocessor_class = recursive_find_python_class([join(sam3d.__path__[0], "preprocessing")],
                                                         self.preprocessor_name, current_module="sam3d.preprocessing")
