...
from sam3d.inference.segmentation_export import save_segmentation_nifti_from_softmax
...
from sam3d.training.loss_functions.dice_loss import DC_and_CE_loss
from sam3d.training.network_training.network_trainer_tumor import NetworkTrainer_tumor
...
class Trainer_tumor(NetworkTrainer_tumor):
    ...
    def load_plans_file(self):
        ...
        #self.plans = load_pickle("../../../DATASET_Tumor/sam3d_raw/sam3d_raw_data/Task03_tumor/Task003_tumor/sam3d_Plansv2.1_plans_3D.pkl")
    ...
    def preprocess_patient(self, input_files):
        ...
        preprocessor_class = recursive_find_python_class([join(sam3d.__path__[0], "preprocessing")],
                                                         preprocessor_name,
                                                         current_module="sam3d.preprocessing")
        assert preprocessor_class is not None, "Could not find preprocessor %s in sam3d.preprocessing" % \
                                               preprocessor_name
    ...
    def validate(self, do_mirroring: bool = True, use_sliding_window: bool = True, step_size: float = 0.5,
        ...
        if run_postprocessing_on_folds:
            # in the old sam3d we would stop here. Now we add a postprocessing. This postprocessing can remove everything
