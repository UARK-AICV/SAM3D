...
from sam3d.training.network_training.network_trainer_acdc import NetworkTrainer_acdc
...
class Trainer_acdc(NetworkTrainer_acdc):
    def __init__(self, plans_file, fold, output_folder=None, dataset_directory=None, batch_dice=True, stage=None,
        ...
        self.init_args = (plans_file, fold, output_folder, dataset_directory, batch_dice, stage, unpack_data,
                          deterministic, fp16, vit_name, sam_ckpt)
    ...
    def validate(self, do_mirroring: bool = True, use_sliding_window: bool = True, step_size: float = 0.5,
        ...
        for k in tqdm(self.dataset_val.keys()):
            ...
            if overwrite or (not isfile(join(output_folder, fname + ".nii.gz"))) or \
                ...
                data[-1][data[-1] == -1] = 0
                # import pdb; pdb.set_trace()
                print("Processing ... _(fname = {})".format(fname))
