...
from sam3d.configuration import default_num_threads, RESAMPLING_SEPARATE_Z_ANISO_THRESHOLD
from sam3d.preprocessing.cropping import get_case_identifier_from_npz, ImageCropper
...
class GenericPreprocessor(object):
    ...
    def preprocess_test_case(self, data_files, target_spacing, seg_file=None, force_separate_z=None):
        ...
        print("load data into preprocess_test_case - data_files: {} - data.shape: {}".format(data_files, data.shape))
