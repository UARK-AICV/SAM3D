...
from sam3d.experiment_planning.summarize_plans import summarize_plans
...
def get_default_configuration(network, task, network_trainer, plans_identifier=default_plans_identifier,
                              search_in=(sam3d.__path__[0], "training", "network_training"),
                              base_module='sam3d.training.network_training'):
    ...
    if task == 'Task001_ACDC':
        ...
        plans['plans_per_stage'][Stage]['pool_op_kernel_sizes'] = [[1, 2, 2], [1, 2, 2], [1, 2, 2]] # for deep supervision
        ...
        plans['plans_per_stage'][Stage]['patch_size'] = np.array([64, 176, 176])
    ...
    print("###############################################")
    print("I am running the following Sam3D: %s" % network)
