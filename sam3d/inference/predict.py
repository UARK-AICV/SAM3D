...
from sam3d.inference.segmentation_export import save_segmentation_nifti_from_softmax, save_segmentation_nifti
...
from sam3d.postprocessing.connected_components import load_remove_save, load_postprocessing
from sam3d.training.model_restore import load_model_and_checkpoint_files
from sam3d.training.network_training.Trainer_acdc import Trainer_acdc
from sam3d.training.network_training.Trainer_synapse import Trainer_synapse

from sam3d.utilities.one_hot_encoding import to_one_hot
...
def predict_cases(model, list_of_lists, output_filenames, folds, save_npz, num_threads_preprocessing,
    ...
    for preprocessed in preprocessing:
        ...
        import pdb; pdb.set_trace()
        # print("image: ", d[-1])
        print("predicting", output_filename, " - d.shape:", d.shape)
        ...
        print("predicting", output_filename, " - softmax.shape:", softmax.shape)
        # import pdb; pdb.set_trace()
        # save_segmentation_nifti_from_softmax(softmax, output_filename, dct, interpolation_order, region_class_order, None, None, npz_file, None, force_separate_z, interpolation_order_z)
...
def predict_from_folder(model: str, input_folder: str, output_folder: str, folds: Union[Tuple[int], List[int]],
    ...
    # output_files = ['/home/bntan/3DSAM-Decoder-1/output/inferTs/patient002_frame12.nii.gz']
    # list_of_lists = [['/home/bntan/3DSAM-Decoder-1/DATASET_Acdc/sam3d_raw/sam3d_raw_data/Task001_ACDC/imagesTs/patient002_frame12_0000.nii.gz']]
